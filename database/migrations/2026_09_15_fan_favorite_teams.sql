...
--
-- Aggiunge il modulo "Squadre che amo" (ricerca su TheSportsDB, stesso principio degli altri
-- moduli "che amo" con catalogo esterno).
--
-- Da eseguire una sola volta sul database di produzione, es.:
--   mysql -u <utente> -p <nome_database> < database/migrations/2026_09_15_fan_favorite_teams.sql
