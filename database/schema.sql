...
-- Pubblicazioni scientifiche/accademiche preferite, cercate sul catalogo CrossRef (registro
-- ufficiale dei DOI, gratuito, nessuna chiave API richiesta). Nessuna colonna immagine: CrossRef
-- non fornisce mai una copertina, a differenza degli altri moduli "che amo" — solo l'eventuale
-- foto personale caricata dall'utente (image_path/image_thumb_path). Vedi app/src/crossref.php.
