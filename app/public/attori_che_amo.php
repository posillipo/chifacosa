...
$sql = 'SELECT * FROM fan_favorite_actors WHERE user_id=? ORDER BY sort_order DESC' . ($isAdminLte ? ' LIMIT 20' : '');
...
<title>Attori che ama <?= e($artist['display_name']) ?> — <?= e(siteName()) ?></title>
<meta property="og:type" content="website">
<meta property="og:title" content="Attori che ama <?= e($artist['display_name']) ?>">
...
<div class="container">
  ...
  <?php else: ?>
    <div class="card">Nessun attore aggiunto ancora.</div>
  <?php endif; ?>
