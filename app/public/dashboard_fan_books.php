    ...
    if ($action === 'add') {
        ...
        if ($bookId !== '') {
            ...
            $stmt = getDB()->prepare('INSERT IGNORE INTO fan_favorite_books
                (user_id, google_books_id, book_title, book_image, show_in_feed, sort_order)
  ...
  (function () {
    ...
    function favoriteRowHtml(item) {
      ...
      return '<div style="display:flex;align-items:center;gap:12px;">'
        ...
        + '<label>Privacy (comparsa nel Feed)</label>'
        + '<div style="display:flex;gap:16px;margin-bottom:14px;">'
        + '<label style="display:flex;align-items:center;gap:6px;font-weight:normal;margin-bottom:0;"><input type="radio" class="bk-pub-visibility" name="visibility" value="public"' + (item.show_in_feed ? ' checked' : '') + ' style="width:auto;"> Pubblico</label>'
        + '<label style="display:flex;align-items:center;gap:6px;font-weight:normal;margin-bottom:0;"><input type="radio" class="bk-pub-visibility" name="visibility" value="private"' + (!item.show_in_feed ? ' checked' : '') + ' style="width:auto;"> Solo io</label></div>'
        + '<label>Programma la comparsa nel Feed (opzionale)</label>'
