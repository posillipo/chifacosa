...
$themePickerBackgrounds = [
    ...
    'geolierstyle' => 'radial-gradient(ellipse 70% 45% at 50% 0%, rgba(227,162,79,0.35), transparent 62%), linear-gradient(180deg, #171310 0%, #0a0908 100%)',
        ...
        <label style="display:block;cursor:pointer;">
          ...
          <div class="card" style="border:2px solid <?= $isSelected ? 'var(--accent)' : 'transparent' ?>;text-align:center;">
            ...
            <?php elseif ($key === 'geolierstyle'): ?>
              <div style="background:<?= e($themePickerBackgrounds[$key]) ?>;border-radius:6px;padding:16px 10px;margin-bottom:10px;">
                <div style="width:40px;height:40px;border-radius:50%;background:#1a1714;margin:0 auto 8px;border:2px solid #fff;"></div>
                <div style="background:#1a1714;border:1px solid rgba(255,255,255,0.14);border-radius:6px;height:10px;margin-bottom:4px;"></div>
                <div style="background:#1a1714;border:1px solid rgba(255,255,255,0.14);border-radius:6px;height:10px;"></div>
              </div>
