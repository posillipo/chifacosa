...
const PAGE_THEMES = [
    ...
    'geolierstyle' => ['label' => 'GeolierStyle', 'description' => 'Atmosfera cinematografica scura ispirata alle grafiche da "link in bio" urban/trap: bagliore ambrato caldo che sfuma nel nero dietro l\'avatar, titolo maiuscolo grassetto, pulsanti a rettangolo scuro con bordo sottile, icone social a cerchio contornato', 'body_class' => 'geolierstyle-page'],
